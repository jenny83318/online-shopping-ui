...
export class PaymentComponent implements OnInit {
  ...
  async StripePay() {
    ...
    let request = new StripeRequest(Math.round(this.order.totalAmt * 100) , prodName , 'hkd', "https://jol-boutique-6375bd33d0fe.herokuapp.com/orderlist", "https://jol-boutique-6375bd33d0fe.herokuapp.com", 1);
