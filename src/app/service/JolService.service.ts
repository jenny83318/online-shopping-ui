...
export class JolService {
  ...
  loginData: any = { account: "", password: "", token: "", email:"" };
  prod: any;
  cartNum: number = 0
  wishNum: number = 0
  isHeaderCheck = false;
  ...
  sendOrderEmail(orderNo: any) {
    const body = {
      ...
      subject: "訂單確認通知",
      content1: "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width,initial-scale=1'><title>JOL Boutique 訂單確認通知信</title></head><body style='padding: 10px;'><div style='text-align: center;'><img style='width: 40%; display: inline-block;' src='cid:image'></div><p>感謝您訂購JOL Boutique的商品，我們將再確認訂單後盡快為您出貨。<br>以下是您訂購的資料:</p><table style='padding-left:10px;width:100%;'><tr><td colspan='2' style='font-size:20px;font-weight:700;color:#bd6c3d'>訂單資訊</td></tr><tr><td colspan='2'><hr></td></tr><tr><td style='width:40%'>訂單編號:&nbsp;</td><td>#JOL-#OrderNo</td></tr><tr><td>訂單日期:&nbsp;</td><td>#OrderDate</td></tr><tr><td>訂單金額:&nbsp;</td><td>$ #OrderAmt</td></tr><tr><td>付款方式:&nbsp;</td><td>#PayBy</td></tr><tr><td>訂單狀態:&nbsp;</td><td>#Status</td></tr><tr><td>寄貨方式:&nbsp;</td><td>#Shipment</td></tr></table><br><br><table style='padding-left: 10px; width: 360px;'><tr><td style='font-size:20px; font-weight:bold; color: rgb(189, 108, 61);'> 訂單明細</td></tr>",
    ...
    let request = new Request("JOLEmailInfo", this.loginData.account, 'UPDATE', body);
    console.log('request', request)
    this.getData(environment.JOLSERVER, request).subscribe(res => {
      console.log('sendOrderEmail', res);
    });
  }
